...
const FetchData=({cat})=>{
    ...
    const fetchData = async ()=>{
        await axios
        .get(
            cat ? `https://newsapi.org/v2/top-headlines?country=in&category=${cat}&apiKey=ffb5029efa8d496abacc9900ed35ef86`
            : "https://newsapi.org/v2/top-headlines?country=in&apiKey=ffb5029efa8d496abacc9900ed35ef86"
        )
        ...
        <div className="container d-flex justify-content-center align-items-center flex-column my-3" style={{minHeight:"100vh"}}>
            ...
            <>
                <div className="container my-3 p-3" style={{width:"700px", boxShadow:"2px 2px 10px silver", borderRadius:"10px"}}>
                    ...
                    <label style={{float:"right"}}><i class="bi bi-bookmark"></i> Save</label>
